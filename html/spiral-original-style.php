...
<head>
    ...
    <style>
        ...
        /* Alpha channel video styling (if using .mov with alpha) */
        .spiral-video-alpha {
            position: absolute;
            width: 100%;
            height: 100%;
            object-fit: cover;
            object-position: center;
            /* No mix-blend-mode needed for alpha channel videos */
...
<body class="text-white min-h-screen">
    ...
    <!-- Spiral Background - Using Original KTP Spiral Videos -->
    <div class="spiral-background">
        <video class="spiral-video" autoplay loop muted playsinline>
            <!-- WebM versions for modern browsers (smaller file size) -->
            ...
            <!-- Alpha channel MOV if needed -->
            <source src="/images/spiral_alpha.mov" type="video/quicktime">
        </video>
    </div>
    ...
    <div class="content-wrapper">
        ...
        <!-- Video Format Test Section -->
        <section class="py-32 px-6">
            <div class="max-w-7xl mx-auto">
                <h2 class="bank-gothic text-4xl text-center mb-8 gradient-text">
                    ORIGINAL SPIRAL FORMATS
                </h2>
                <p class="text-center text-gray-400 mb-12">
                    Testing different versions of the original KTP spiral animation
                </p>
                
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="glass-card p-6 rounded-xl">
                        <h3 class="text-xl font-bold mb-3">Alpha Channel (.mov)</h3>
                        <p class="text-gray-400 text-sm mb-2">225MB - Transparency support</p>
                        <code class="text-xs text-blue-400">/images/spiral_alpha.mov</code>
                    </div>
                    <div class="glass-card p-6 rounded-xl">
                        <h3 class="text-xl font-bold mb-3">1080p MP4</h3>
                        <p class="text-gray-400 text-sm mb-2">Standard web format</p>
                        <code class="text-xs text-blue-400">/images/spiral_1080p.mp4</code>
                    </div>
                    <div class="glass-card p-6 rounded-xl">
                        <h3 class="text-xl font-bold mb-3">720p MP4</h3>
                        <p class="text-gray-400 text-sm mb-2">Mobile optimized</p>
                        <code class="text-xs text-blue-400">/images/spiral_720p.mp4</code>
                    </div>
                    <div class="glass-card p-6 rounded-xl">
                        <h3 class="text-xl font-bold mb-3">WebM Lossless</h3>
                        <p class="text-gray-400 text-sm mb-2">Modern browsers</p>
                        <code class="text-xs text-blue-400">/images/spiral_lossless_1080p.webm</code>
                    </div>
                </div>
            </div>
        </section>
