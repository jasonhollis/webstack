...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['action'] === 'get_quote') {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO premium_leads (name, email, phone, suburb, budget_range, ip_address, source, estimated_value) VALUES (?, ?, ?, ?, ?, ?, 'premium_landing_v4', ?)");
        ...
        header('Location: /premium-landing-v4.php?success=1');
        exit;
    } catch (Exception $e) {
...
$page_desc = "White glove IT consulting and home automation for Melbourne's finest properties. Enterprise-grade solutions from $25K-$200K+";
$dark_mode = false; // We'll handle our own dark sections
$use_bank_gothic = true;
$fullbleed = true; // We want full width for our hero
$hide_nav = true; // We have our own custom nav in the hero
$hide_footer = false; // Use the standard footer
...
<!-- Custom Navigation Bar for this page -->
