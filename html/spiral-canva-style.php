...
<body class="text-white min-h-screen">
    ...
    <div class="spiral-background">
        <video id="spiralVideo" class="spiral-image" autoplay loop muted playsinline>
            <source src="/test-videos/AdobeStock_536446830_Video_HD_Preview.mov" type="video/quicktime">
            <source src="/test-videos/AdobeStock_536446830_Video_HD_Preview.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <script>
        // Set video playback speed to 0.25x for slow, ambient effect
        document.addEventListener('DOMContentLoaded', function() {
            const video = document.getElementById('spiralVideo');
            if (video) {
                video.playbackRate = 0.25;
                
                // Ensure video plays even after user interaction
