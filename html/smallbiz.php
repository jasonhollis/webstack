...
$page_desc = "SMB IT solutions from KTP Digital: networking, cloud, Ubiquiti/UniFi, Mac integration, NextDNS, Tailscale, NAS, backup, and expert support.";
...
<div>
  ...
  <div class="mb-5 text-lg font-medium">
    Running a small business doesn’t mean compromising on IT, security, or support. KTP Digital brings <strong>enterprise-level</strong> solutions and true white glove service to the SMB sector—covering <b>networking, cloud, Mac, remote access, security, and more.</b>
  </div>
  <ul class="text-left max-w-2xl mx-auto mb-6 list-disc list-inside space-y-1 text-base">
    ...
    <li>Cloud migrations – Office 365, Google Workspace, integrated Mac support</li>
