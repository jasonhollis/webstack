...
<div class="mt-12 mb-8 text-center">
  ...
  <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center">
    ...
    <a href="/security.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-5 text-white shadow text-center flex flex-col items-center">
    ...
    <a href="/email.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-5 text-white shadow text-center flex flex-col items-center">
    ...
    <a href="/integration.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-5 text-white shadow text-center flex flex-col items-center">
    ...
    <!-- 5: Cloud, Backup & NAS (QNAP official SVG, forced white if possible) -->
    <a href="/cloud.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-5 text-white shadow text-center flex flex-col items-center">
    ...
    <a href="/automation.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-5 text-white shadow text-center flex flex-col items-center">
    ...
    <a href="/disaster-recovery.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-5 text-white shadow text-center flex flex-col items-center">
...
<div class="grid gap-8 sm:grid-cols-3 mt-12 text-left text-gray-200 text-base justify-center">
  <!-- Small Business (Apple SVG) -->
  <a href="/smallbiz.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-6 shadow text-center flex flex-col items-center no-underline text-white">
  ...
  <a href="/enterprise.php" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-6 shadow text-center flex flex-col items-center no-underline text-white">
  ...
  <!-- Home & SOHO (Home Assistant SVG) -->
  <a href="/about.php#home-soho" class="bg-slate-900/80 hover:bg-blue-600 transition rounded-xl p-6 shadow text-center flex flex-col items-center no-underline text-white">
    <img src="/images/icons/home-assistant.svg" class="w-12 h-12 mb-2 opacity-90" alt="Home & SOHO" />
    <div class="font-bold mb-1">Home & SOHO</div>
    <div class="text-xs opacity-80">Mac, Windows, Home Assistant, smart networks.</div>
  </a>
</div>
